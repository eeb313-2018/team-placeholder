...
Selection also acts on the life history (or lifecycle) of species, which are the patterns of survival and reproduction events 
that occur over the lifetime of an individual. Life history traits consist of trade-offs between growth, survival, and 
...
higher so more time has passed for any phylogenetically linked traits to be broken, but a sister group analysis would be 
required to conclusively dismiss this possibility.
